function Enable-SeDebugPrivilege {
    $definition = @'
        ...
        public class PrivilegeAdjusterX {
...
'@
    ...
    return [PrivilegeAdjusterX]::EnableDebugPrivilege()
}


$success = Enable-SeDebugPrivilege
if ($success) {
    Write-Output "SeDebugPrivilege has been succesfully enabled."
} else {
    Write-Output "It was not possible to enable SeDebugPrivilege."
}
